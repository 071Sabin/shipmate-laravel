...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-div right-side">
        ...
        <?php if( !empty(!session('seller_register_process_done')) and !empty(!session('wrong_seller_otp'))): ?>
        ...
        <?php if( !empty(session('seller_register_process_done')) or !empty(session('wrong_seller_otp'))): ?>
...
<?php echo $__env->make('seller.seller_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\01PARUL\ASMP_Project\project_ASMP1\ship-mate - Copy\resources\views/seller/seller_signup.blade.php ENDPATH**/ ?>