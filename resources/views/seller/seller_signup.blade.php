...
@section('content')
    ...
    <div class="form-div right-side">
        ...
        @if( !empty(!session('seller_register_process_done')) and !empty(!session('wrong_seller_otp')))
        ...
        @if( !empty(session('seller_register_process_done')) or !empty(session('wrong_seller_otp')))
